...
async def test_ai_query_api(
    ...
    steps = builder.query.get_steps(
        status=AgentExecutionStatus.Completed,
        dids=[
            "did:nv:06d810d0f78ebbc229892182e0d1354cf35d80627a6d7af28624017e1a380182"
        ],
    )
    assert isinstance(steps, GetStepsDtoResult)

    steps_from_task = builder.query.get_steps_from_task(
        did="did:nv:06d810d0f78ebbc229892182e0d1354cf35d80627a6d7af28624017e1a380182",
        task_id="task-1015a1ee-b230-49a0-9214-2ba1764046ec",
    )
    ...
    task_with_steps = subscriber.query.get_task_with_steps(
        did="did:nv:06d810d0f78ebbc229892182e0d1354cf35d80627a6d7af28624017e1a380182",
        task_id="task-1015a1ee-b230-49a0-9214-2ba1764046ec",
    )
