...
# Define Enum for AgentExecutionStatus if not already defined
...
class AIQueryApi(NVMBackendApi):
    ...
    async def get_steps(self,
                        ...
                        dids: List[str] = []):
        endpoint = f'{GET_BUILDER_STEPS_ENDPOINT}?'
        if status:
    ...
    async def get_tasks_from_agents(self):
        return await self.get(GET_AGENTS_ENDPOINT)
